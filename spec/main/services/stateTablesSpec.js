...
describe('service', function() {
  ...
  describe('stateTables', function() {
    ...
    describe('roundsSummaryTables(<round_index>)', function() {
      describe('not isTeamTournament', function() {
        it('should build a result table for round <round_index>', function() {
          var st = {
            players: [
              ...
              { bracket: [null, null],
                games: [
                  [ { table:1, victory: null,
                      p1: { name: 'p1', list: 'list11', tournament: 1,
                            control: 111, army: 112, custom_field: 113 },
                      p2: { name: 'p2', list: 'list21', tournament: 0,
                            control: 121, army: 122, custom_field: 123 }
                    },
                    { table:2, games: [],
                      victory: null,
      ...
      describe('isTeamTournament', function() {
        it('should build a result table for round <round_index>', function() {
          var st = {
            players: [
              [ { name: 'p1', droped: null,
                  members: [ { name: 'm1', droped: null,
                               lists: ['list11','list12'], lists_played: ['list11','list12'] } ] },
                { name: 'p2', droped: null,
                  members: [ { name: 'm2', droped: null,
                               lists: ['list21','list22'], lists_played: ['list21'] } ] },
                { name: 'p3', droped: null, lists: ['list31','list32'], lists_played: ['list31','list32'] },
                { name: 'p4', droped: null, lists: ['list41','list42'], lists_played: ['list41'] }
              ],
              [ { name: 'p5', droped: 1, lists: ['list51','list52'], lists_played: ['list51','list52'] },
            ...
            rounds: [
              { bracket: [null, null],
                games: [
                  [ { table:1, victory: null,
                      p1: { name: 'p1', team_tournament: 1, tournament: 1,
                            control: 111, army: 112, custom_field: 113, assassination: 0, },
                      p2: { name: 'p2', team_tournament: 0, tournament: 0,
                            control: 121, army: 122, custom_field: 123, assassination: 0, },
                      games: [ { games: [], victory: null,
                                 p1: { name: 'm1', list: 'list11', tournament: 1,
                                       control: 111, army: 112, custom_field: 113 },
                                 p2: { name: 'm2', list: 'list21', tournament: 0,
                                       control: 121, army: 122, custom_field: 123 } }
                             ],
                    },
                    { table:2, games: [],
              ...
              { bracket: [1, null],
                games: [
                  [ { table:1, victory: null,
                      p1: { name: 'p1', team_tournament: 1, tournament: 1,
                            control: 211, army: 212, custom_field: 213, assassination: 1, },
                      p2: { name: 'p2', team_tournament: 1, tournament: 0,
                            control: 221, army: 222, custom_field: 223, assassination: 0, },
                      games: [ { games: [], victory: 'assassination',
                                 p1: { name: 'm1', list: 'list12',
                                       tournament: 1, control: 211, army: 212, custom_field: 213 },
                                 p2: { name: 'm2', list: 'list21',
                                       tournament: 0, control: 221, army: 222, custom_field: 223 } }
                             ]
                    },
                    { table:2, games: [],
          ...
          expect(res).toEqual([
            [ [ 'Group1' ],
              [ 'Team', 'Player', 'Lists Played', 'Round1', 'Semi-finals' ],
              [ 'p1', '', '',
                { value : 'W - p2', color : 'limegreen' },
                { value : 'W - p2', color : 'limegreen' } ],
              [ '', 'm1', '2/2',
                { value : 'W - m2', color : 'limegreen' },
                { value : 'W - m2', color : 'limegreen' } ],
              [ 'p2', '', '',
                { value : 'L - p1', color : 'red' },
                { value : 'W - p1', color : 'limegreen' } ],
              [ '', 'm2', '1/2',
                { value : 'L - m1', color : 'red' },
                { value : 'L - m1', color : 'red' }
              ],
              [ '', 'p3', '2/2',
                { value : 'W - p6', color : 'limegreen' },
            ...
            [ [ 'Group2' ],
              [ 'Team', 'Player', 'Lists Played', 'Round1', 'Round2' ],
              [ '', 'p5', '2/2',
